      ...
      <footer className="bg-gray-800 text-white py-12">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-xl font-bold mb-4">Centro de Artesanato</h3>
              <p className="text-gray-400">Valorizando a arte e cultura dos artesãos brasileiros desde 2023.</p>
            </div>
            <div>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li className="text-gray-400">contato@centroartesanato.com.br</li>
          ...
          <div className="mt-8 pt-8 border-t border-gray-700 text-center">
            <p className="text-gray-400">
              &copy; {new Date().getFullYear()} Centro de Artesanato. Todos os direitos reservados.
            </p>
          </div>
        </div>
      </footer>
